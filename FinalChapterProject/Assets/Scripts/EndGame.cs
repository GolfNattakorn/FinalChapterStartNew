...
public class EndGame : MonoBehaviour
{
    ...
    public void AllScoreSummarize()
    {
        if(allScore >= 6)
        {
            ...
            summarizeExplain.text = "คุณ " + registration.yourName.text + " คูณใช้ชีวิตได้ดีมาก"; /// you live very well
        ...
        else if (allScore >= 3)
        {
            ...
            summarizeExplain.text = "คุณ " + registration.yourName.text + " ถือว่าคูณใช้ชีวิตได้ดี"; /// You're living a very good life.
        }
        else
        {
            summarizeText.text = "แย่";
            summarizeImage.sprite = summarizeSprite[2];
            summarizeExplain.text = "คุณ " + registration.yourName.text + " คูณใช้ชีวิตได้ไม่ดีเลยนะ"; /// You're not living well.
        }
    }
